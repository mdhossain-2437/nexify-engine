...
.bg-white { background: rgba(30, 41, 59, 0.8); backdrop-filter: blur(12px); border: 1px solid rgba(148, 163, 184, 0.1); }`,
  },
  {
    slug: 'starter-store',
    name: 'Starter Store',
    description: 'Production-ready ecommerce theme. Optimized for conversions with clean product pages and a modern checkout.',
    category: 'ecommerce',
    colors: {
      primary: '#2563eb',
      secondary: '#475569',
  ...
  },
  {
    slug: 'nature',
    name: 'Nature',
    description: 'Earthy tones and organic feel. Perfect for eco-friendly and wellness stores.',
    category: 'ecommerce',
    colors: {
      primary: '#059669',
      secondary: '#65a30d',
